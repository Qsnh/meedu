...
const DecorationPcPagesPage = () => {
  ...
  useEffect(() => {
    document.title = "PC装修页面管理";
    dispatch(titleAction("PC装修页面管理"));
  }, []);
        ...
        return (
          <Space>
            <PerButton
              ...
              onClick={() => {
                navigate("/decoration/pc/editor?page_id=" + record.id);
              }}
              disabled={null}
            />
            <Dropdown menu={{ items }}>
  ...
  const handleCreateSubmit = () => {
    form.validateFields().then((values) => {
      ...
      decorationPage
        .store({
          name: values.name,
          page_key: "pc-page-index", // PC 页面使用固定的 page_key
        })
        .then(() => {
          setLoading(false);
...
export default DecorationPcPagesPage;
