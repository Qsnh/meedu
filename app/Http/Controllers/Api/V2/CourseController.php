 ...
 *         type="object",
 *         title="课程",
 *         @OA\Property(property="id",type="int64",description="课程id"),
 ...
 *         @OA\Property(property="charge",type="int32",description="课程价格"),
...
class CourseController extends BaseController
{
     ...
     *                 @OA\Property(property="data",type="Arrays",description="数据列表",ref="#/components/schemas/Course"),
     *             ),
     *         )
     *     )
     * )
     ...
     *             @OA\Property(property="message",type="string",description="消息"),
     *             @OA\Property(property="data",type="Object",description="",
     *                 @OA\Property(property="comments",type="Arrays",description="评论",ref="#/components/schemas/CourseComment"),
