...
class H5VodV1HTMLHook implements HookRuntimeInterface
{
    public function handle(HookParams $params, \Closure $closure)
    {
        ...
        if ($courseIds) {
            ...
            $html = app('Illuminate\View\Factory')->file(resource_path('views/h5/view-block/vod-v1.blade.php'), ['block' => $block])->render();
