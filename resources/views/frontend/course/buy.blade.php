                        ...
                        <div class="col-12 px-5 py-4">
                            ...
                            <div class="row py-5 border-bottom border-secondary">
                                <div class="col-md-8 col-12">
                                    <h4 class="fw-400">{{$course['title']}}</h4>
                                </div>
                                <div class="col-md-4 col-12 text-right">
                                    <span class="fs-24px">￥{{$course['charge']}}</span>
                                </div>
                            </div>
                            <div class="row py-5">
                                <div class="col-12 text-right">
                                    <p>总价<span class="ml-3">￥{{$course['charge']}}</span></p>
                            ...
                            <div class="row py-5 justify-content-end">
                                <div class="col-md-3 col-12 text-right">
                                    <p class="text-right">总计 <span class="ml-4 total">￥{{$course['charge']}}</span></p>
