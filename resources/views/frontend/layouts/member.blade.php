        ...
        <div class="flex py-10">
            <div class="w-48 flex-initial">
                <nav class="bg-white rounded py-2 space-y-1">
                    <a href="{{route('member')}}"
                       class="{{request()->routeIs(['member']) ? 'bg-white text-blue-600 font-medium' : 'text-gray-500'}} hover:bg-white group rounded px-3 py-3 flex items-center justify-center text-base">
                        <i class="iconfont icon-banjiguanli2x inline-block mr-2" style="font-size: 20px"></i>
                        <span class="truncate">{{__('用户中心')}}</span>
                    </a>

                    <a href="{{route('member.profile')}}"
                       class="{{request()->routeIs(['member.profile']) ? 'bg-white text-blue-600 font-medium' : 'text-gray-500'}} hover:bg-white group rounded px-3 py-3 flex items-center justify-center text-base">
                    ...
                    <a href="{{route('member.orders')}}"
                       class="{{request()->routeIs(['member.orders']) ? 'bg-white text-blue-600 font-medium' : 'text-gray-500'}} hover:bg-white group rounded px-3 py-3 flex items-center justify-center text-base">
                    ...
                    <a href="{{route('member.messages')}}"
                       class="{{request()->routeIs(['member.messages']) ? 'bg-white text-blue-600 font-medium' : 'text-gray-500'}} hover:bg-white group rounded px-3 py-3 flex items-center justify-center text-base">
                    ...
                    <a href="{{route('member.credit1_records')}}"
                       class="{{request()->routeIs(['member.credit1_records']) ? 'bg-white text-blue-600 font-medium' : 'text-gray-500'}} hover:bg-white group rounded px-3 py-3 flex items-center justify-center text-base">
