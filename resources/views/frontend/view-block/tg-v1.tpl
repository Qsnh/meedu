            ...
            <a href=""
               class="rounded bg-white hover:shadow-lg course-item group">
                ...
                <div class="w-full flex py-2 px-2 items-center">
                    <div class="flex-1">
                        <div>
                            <span class="text-red-500 text-2xl"><small>￥</small></span>
                        </div>
                        <div>
                    ...
                    <div>
                        <div style="width: 137px;height: 48px;line-height:48px;background: linear-gradient(90deg, #FF2276 0%, #FF897C 100%);border-radius: 4px"
