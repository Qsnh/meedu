...
@section('content')
    ...
    <div class="w-full px-3 py-6 lg:max-w-6xl lg:mx-auto">
        <div class="bg-white rounded shadow p-5">
            ...
            <div class="bg-gray-100 p-5 mt-5 rounded">
                <div class="text-gray-500 mb-5 text-sm flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                    </svg>
                    <span class="ml-1">{{__('收款信息及要求')}}</span>
                </div>
                <div class="leading-loose text-gray-800">
                    {!! $intro !!}
                </div>
            </div>
        </div>
