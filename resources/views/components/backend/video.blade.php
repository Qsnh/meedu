    ...
    <div class="tab">
        <div class="tab-header">
            <ul>
                ...
                <li class="active" data-id="tab-vod">腾讯云视频服务</li>
        ...
        <div class="tab-body">
            ...
            <div class="tab-body-box active" id="tab-vod">
                <div class="alert alert-warning">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-danger" id="vod-stop-upload">停止上传</button>
                </div>
