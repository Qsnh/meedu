        ...
        <div class="col-sm-12">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="from_name" value="{{$one->from_name}}" class="form-control"
                           placeholder="推广链接名" required>
                </div>
                <div class="form-group">
                    <label>推广链接特征值 @include('components.backend.required')</label>
                    <input type="text" name="from_key" value="{{$one->from_key}}" class="form-control"
                           placeholder="推广链接特征值" required>
                </div>
                <div class="form-group">
