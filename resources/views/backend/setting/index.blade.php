...
@section('base')
    ...
    <aside class="aside aside-expand-md">
        <div class="aside-body">
            <div class="aside-block">
                <a class="btn btn-block btn-info" href="#">Compose</a>
            </div>
            ...
            <div class="aside-block">
                <div class="flexbox mb-1">
                    <h6 class="aside-title">Labels</h6>
                    <a class="btn btn-xs btn-pure btn-primary float-right" href="#" data-provide="tooltip" data-title="Create new label"><i class="ti-plus"></i></a>
                </div>
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        ...
                        <a class="nav-action hover-info" href="#" data-provide="tooltip" data-title="Edit"><span class="ti-pencil"></span></a>
                        <a class="nav-action hover-danger" href="#" data-provide="tooltip" data-title="Remove"><span class="ti-close"></span></a>
                    </li>
                    <li class="nav-item">
    ...
    <form action="" method="post">
        ...
        <ul class="nav nav-tabs nav-tabs-success">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#socialite">第三方登录</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#aliyun-email">阿里云邮箱</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#sms">短信配置</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#image">图片上传设置</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#payment">支付配置</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#video">视频上传</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#member">会员配置</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#seo">SEO配置</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="socialite">
                <div class="nav-tabs-left">
                    <ul class="nav nav-tabs nav-tabs-success">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#socialite-github">Github登录</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#socialite-qq">QQ登录</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="socialite-github">
                            <div class="form-group">
                                <label></label><br>
            ...
            <div class="tab-pane fade" id="sms">
                <div class="nav-tabs-left">
                    <ul class="nav nav-tabs nav-tabs-success">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#sms-service">服务商</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#sms-aliyun">阿里云短信</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#sms-yunpian">云片短信</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="sms-service">
                            <div class="form-group">
                                <label>短信服务商</label>
            ...
            <div class="tab-pane fade" id="payment">
                <div class="nav-tabs-left">
                    <ul class="nav nav-tabs nav-tabs-success">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#payment-alipay">支付宝</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#payment-wechat">微信</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#payment-eshanghu">易商户</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="payment-alipay">
                            <div class="form-group">
                                <label>是否开启</label><br>
            ...
            <div class="tab-pane fade" id="video">
                <div class="nav-tabs-left">
                    <ul class="nav nav-tabs nav-tabs-success">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#video-aliyun">阿里云视频</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#video-tencent">腾讯云视频</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="video-aliyun">
                            <div class="alert alert-warning">
            ...
            <div class="tab-pane fade" id="seo">
                <div class="nav-tabs-left">
                    <ul class="nav nav-tabs nav-tabs-success">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#seo-index">首页</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#seo-course-list">课程列表</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#seo-vip">订阅页面</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="seo-index">
                            <div class="form-group">
                                <label>首页标题</label>
