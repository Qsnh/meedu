...
@section('content')
    ...
    <div class="nav-menus">
        <a class="menu-item {{!$scene ? 'active' : ''}}"
           href="{{route('member.courses')}}?scene=">已购课程</a>
        <a class="menu-item {{$scene === 'videos' ? 'active' : ''}}"
           href="{{route('member.courses')}}?scene=videos">已购视频</a>
        <a class="menu-item {{$scene === 'like' ? 'active' : ''}}"
           href="{{route('member.courses')}}?scene=like">我的收藏</a>
        <a class="menu-item {{$scene === 'history' ? 'active' : ''}}"
           href="{{route('member.courses')}}?scene=history">历史学习</a>
    </div>
